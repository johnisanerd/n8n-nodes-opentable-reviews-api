...
import { ACTOR_ID } from '../ApifyOpenTableReviews.node';
import { buildActorInput } from '../ApifyOpenTableReviews.properties';
...
function shapeItem(
	...
	// simplified
	const rating = (item.rating ?? {}) as Record<string, any>;
